...
public class ItemBehavior : MonoBehaviour
{
    ...
    private void AddItem(InterfaceBase_IItem item)
    {
        ...
        Debug.Log($"[Item_Behavior] Added {itemName} to Inventory. Current Items in Inventory: {inventory.Count}");
...
public void EquipFromInventory(int index)
{
    ...
    Debug.Log($"[Item_Behavior] Switched to {itemName}");
}
    /*
    public void EquipFromInventory(int index)
    {
    ...
    public void Equip(InterfaceBase_IItem newItem)
{
    ...
    Debug.Log($"[Item_Behavior] Equiped {itemBase.name} done");
}
    /*
...
/*
    ...
    */
    ...
    {
        if (itemBase == null) return;
        Debug.Log($"[Item_Behavior] Drop {itemBase.itemData.Name}");
